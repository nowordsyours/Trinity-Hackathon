"""
Enhanced Smart Toilet Hygiene System with JWT Authentication
...
users_db = {
    ...
    'cleaner@staff.com': {
        'password': generate_password_hash('cleaner123'),
        'role': 'cleaner',
        'name': 'Cleaning Staff'
    },
    'admin@system.com': {
...
toilets_data = [
    {
        ...
        'cleaner_assigned': 'cleaner@staff.com',
        'occupancy': 'low',
...
def update_toilet_status(toilet_id):
    ...
    try:
        ...
        toilet['last_cleaned'] = datetime.now()
        toilet['last_updated'] = datetime.now()
        toilet['cleaner_assigned'] = current_user['email']
...
if __name__ == '__main__':
    ...
    print("📍 Public Dashboard: http://localhost:5000/public-dashboard")
    print("🧽 Cleaner Dashboard: http://localhost:5000/cleaner-dashboard")
