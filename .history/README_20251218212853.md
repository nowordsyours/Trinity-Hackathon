...
## 🏆 Hackathon-Ready AI/ML Solution

A complete end-to-end AI model for predicting public toilet hygiene levels using IoT sensor data. Built for hackathon demonstrations with production-ready code and explainable AI features.

## 🎯 Problem Solved

**Predict hygiene levels** in public toilets using real-time IoT sensor data:
- **Hygiene Score**: Continuous value (0-100)
- **Hygiene Status**: Clean (≥80), Moderate (50-79), Dirty (<50)
